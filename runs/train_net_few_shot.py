...
def train_epoch(
    ...
    with logging_redirect_tqdm(), tqdm.tqdm(train_loader, desc=f'Train epoch {cur_epoch}') as pbar: 
...
def eval_epoch(val_loader, model, val_meter, cur_epoch, cfg, writer=None):
    ...
    with logging_redirect_tqdm(), tqdm.tqdm(val_loader, desc=f'Eval epoch {cur_epoch}') as pbar:
        for cur_iter, task_dict in enumerate(pbar):
